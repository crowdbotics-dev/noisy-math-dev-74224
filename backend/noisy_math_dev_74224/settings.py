"""
Django settings for noisy_math_dev_74224 project.
...
ROOT_URLCONF = 'noisy_math_dev_74224.urls'
...
WSGI_APPLICATION = 'noisy_math_dev_74224.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_math_dev_74224 API",
    "DESCRIPTION": "API documentation for noisy_math_dev_74224 App",
    "VERSION": "v1",
}
